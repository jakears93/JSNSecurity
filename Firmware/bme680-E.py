...
try:
	...
	#add timestamp/date to files aswell
        ...
        #uploads information DataBase
    #username = "jacob"
    #room = "BedRoom"
    #storagepath = username+"/"+room+"/temp.txt"
    #firebase = pyrebase.initialize_app(config)              
    #storage = firebase.storage()
    #fbupload = storage.child(storagepath).put("temp.txt")

    #storage.child("jacob/BedRoom/temp.txt").put("temp.txt")
